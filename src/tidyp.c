...
static const CmdOptDesc cmdopt_defs[] =  {
    { "-output <file>",
      ...
      "output-file: <file>", CmdOptFileManip, "-o <file>", NULL },
    { "-config <file>",
      "set configuration options from the specified <file>",
      NULL, CmdOptFileManip, NULL, NULL },
    { "-file <file>",
      "write errors and warnings to the specified <file>",
      "error-file: <file>", CmdOptFileManip, "-f <file>", NULL },
    { "-modify",
      "modify the original input files",
      "write-back: yes", CmdOptFileManip, "-m", NULL },
    { "-indent",
      "indent element content",
      "indent: auto", CmdOptProcDir, "-i", NULL },
    { "-wrap <column>",
      ...
      "\"wrap\" applies.",
      "wrap: <column>", CmdOptProcDir, "-w <column>", NULL },
    { "-upper",
      "force tags to upper case",
      "uppercase-tags: yes", CmdOptProcDir, "-u", NULL },
    { "-clean",
      "replace FONT, NOBR and CENTER tags by CSS",
      "clean: yes", CmdOptProcDir, "-c", NULL },
    { "-bare",
      "strip out smart quotes and em dashes, etc.",
      "bare: yes", CmdOptProcDir, "-b", NULL },
    { "-numeric",
      "output numeric rather than named entities",
      "numeric-entities: yes", CmdOptProcDir, "-n", NULL },
    { "-errors",
      "show only errors and warnings",
      "markup: no", CmdOptProcDir, "-e", NULL },
    { "-quiet",
      "suppress nonessential output",
      "quiet: yes", CmdOptProcDir, "-q", NULL },
    { "-omit",
      "omit optional end tags",
      "hide-endtags: yes", CmdOptProcDir, NULL, NULL },
    { "-xml",
      "specify the input is well formed XML",
      "input-xml: yes", CmdOptProcDir, NULL, NULL },
    { "-asxml",
      "convert HTML to well formed XHTML",
      "output-xhtml: yes", CmdOptProcDir, "-asxhtml", NULL },
    { "-ashtml",
      "force XHTML to well formed HTML",
      "output-html: yes", CmdOptProcDir, NULL, NULL },
#if SUPPORT_ACCESSIBILITY_CHECKS
    { "-access <level>",
      "do additional accessibility checks (<level> = 0, 1, 2, 3)"
      ". 0 is assumed if <level> is missing.",
      "accessibility-check: <level>", CmdOptProcDir, NULL, NULL },
#endif
    { "-raw",
      "output values above 127 without conversion to entities",
      NULL, CmdOptCharEnc, NULL, NULL },
    { "-ascii",
    ...
    { "-language <lang>",
      ...
      "language: <lang>", CmdOptCharEnc, NULL, NULL },
#endif
    { "-version",
      "show the version of Tidy",
      NULL, CmdOptMisc, "-v", NULL },
    { "-help",
      "list the command line options",
      NULL, CmdOptMisc, "-h", "-?" },
    { "-xml-help",
      "list the command line options in XML format",
      NULL, CmdOptMisc, NULL, NULL },
    { "-help-config",
    ...
    { "-show-config",
      ...
      NULL, CmdOptMisc, NULL, NULL },
    { NULL, NULL, NULL, CmdOptMisc, NULL, NULL }
};
